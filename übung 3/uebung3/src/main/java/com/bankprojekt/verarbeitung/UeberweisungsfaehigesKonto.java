...
public abstract class UeberweisungsfaehigesKonto extends Konto {
     ...
     */
    public abstract boolean ueberweisungAbsenden(double betrag, 
     ...
     */
    public abstract void ueberweisungEmpfangen(double betrag, String vonName, long vonKontonr, long vonBlz, String verwendungszweck);
}
